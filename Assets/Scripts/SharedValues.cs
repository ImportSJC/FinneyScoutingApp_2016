...
public class SharedValues : MonoBehaviour
{
    ...
    public enum screens { page0 = 0, page1, page2, page3, page4, bluetooth };
    private static GameObject page0, page1, page2, page3, page4, pageBluetooth;
    ...
    private GameObject ConnectToServer_Button;
    private GameObject CreateServer_Button;
    private GameObject StopServer_Button;
    private GameObject Disconnect_Button;
    ...
    void Start()
    {
        ...
        pageBluetooth = findGameObject("PageBluetooth");
    ...
    {
        StopServer_Button.SetActive(true);
        CreateServer_Button.SetActive(false);
    ...
    {
        StopServer_Button.SetActive(false);
        Disconnect_Button.SetActive(false);
        CreateServer_Button.SetActive(true);
    ...
    void Update()
    {
        if (screen == (int)screens.bluetooth && StopServer_Button == null)
        {
            StopServer_Button = GameObject.Find("StopServer_Button");
            if(StopServer_Button != null)
                StopServer_Button.SetActive(false);
        }

        if (screen == (int)screens.bluetooth && Disconnect_Button == null)
        {
            Disconnect_Button = GameObject.Find("Disconnect_Button");
            if (Disconnect_Button != null)
                Disconnect_Button.SetActive(false);
        }

        if (screen == (int)screens.bluetooth && CreateServer_Button == null)
            CreateServer_Button = GameObject.Find("CreateServer_Button");
        if (screen == (int)screens.bluetooth && ConnectToServer_Button == null)
            ConnectToServer_Button = GameObject.Find("ConnectToServer_Button");
        ...
        page0.SetActive(screen == (int)screens.page0);
        page1.SetActive(screen == (int)screens.page1);
        page2.SetActive(screen == (int)screens.page2);
        page3.SetActive(screen == (int)screens.page3);
        page4.SetActive(screen == (int)screens.page4);
        pageBluetooth.SetActive(screen == (int)screens.bluetooth);
